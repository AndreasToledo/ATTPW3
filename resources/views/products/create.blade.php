    ...
    <main>
        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="number" id="price" name="price" step="0.01" value="{{ old('price') }}" required style="width: 100%; padding: 10px; margin-top: 5px;">
            </div>

            <button type="submit" style="padding: 10px 15px; background-color: green; color: white; border: none; border-radius: 5px; cursor: pointer; margin-right: 10px;">Salvar Produto</button>

...
<body>
    ...
    <main>
        ...
        <a href="{{ route('users.edit', $users->id) }}" style="display: inline-block; padding: 10px 15px; background-color: orange; color: white; text-decoration: none; border-radius: 5px; cursor: pointer;">Editar</a>
    </main>
</body>
</html>
